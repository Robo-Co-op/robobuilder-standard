...
> - **What**: Generate multiple radically different interface designs for a module using parallel sub-agents
> - **When**: see the description above for trigger keywords; details in the body below.
> - **See Also**: /robobuilder:grill-me, /robobuilder:grill-with-docs, /robobuilder:to-prd
